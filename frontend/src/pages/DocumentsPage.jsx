		...
		return (
			<MainLayout>
				...
				<div className="documentos-card" style={styles.card}>
					...
					{esConsultor && (
						<div style={{ ...styles.alertInfo, display: 'flex', alignItems: 'center', gap: '8px' }}>
							...
							<span><strong>Modo consulta:</strong> Usted tiene acceso de solo lectura. No puede agregar ni editar documentos.</span>
						</div>
					)}
